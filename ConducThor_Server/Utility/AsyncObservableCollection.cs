...
namespace ConducThor_Server.Utility
{
    ...
    public class AsyncObservableCollection<T> : IDisposable, IList<T>, IList, IReadOnlyList<T>, INotifyCollectionChanged, INotifyPropertyChanged
    {
        #region Constructor
        ...
        public AsyncObservableCollection(ObservableCollection<T> collection) : this()
        {
            if (collection == null)
            {
        ...
        public AsyncObservableCollection(SynchronizationContext context)
        {
            if (context == null)
        ...
        public AsyncObservableCollection(ObservableCollection<T> collection, SynchronizationContext context) : this(context)
        {
            if (collection == null)
                throw new ArgumentNullException("collection", "'collection' cannot be null");
